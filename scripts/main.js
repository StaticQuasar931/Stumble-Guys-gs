...
'use strict';
{
  const DISPATCH_WORKER_SCRIPT_NAME = "https://unblockedgames-extensions.github.io/s/stumbleguys/scripts/dispatchworker.js";
  const JOB_WORKER_SCRIPT_NAME = "https://unblockedgames-extensions.github.io/s/stumbleguys/scripts/jobworker.js";
...
'use strict';
{
  if (window["C3_IsSupported"]) {
    ...
    window["c3_runtimeInterface"] = new self.RuntimeInterface({
      ...
      engineScripts: ["https://unblockedgames-extensions.github.io/s/stumbleguys/scripts/c3runtime.js"],
      projectScripts: [],
      mainProjectScript: "",
      scriptsType: "module",
